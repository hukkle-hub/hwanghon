...
(function(){
  ...
  var QUESTS = [
    ...
    { id:'q_relay', name:'배전 통제실 정지', area:'지하시설', sub:'3경구 변전소', risk:'S', reward:21000, recLv:28, recCp:26000, time:'00:22:00',
      ...
      loot:['a_steel_gauntlet','m_core','m_shard','m_alloy'], firstClear:'m_heart', drops:{ common:['m_ore','m_alloy','c_antidote'], rare:['m_core','m_shard'], low:['acc_band'] }, note:'', checklist:[], src:'fill' },
    ...
    /* 7장 — 도심지 첫 의뢰. 외곽지대를 다 돈 뒤에 열리므로 B급 회수 일감이 아니라 A급이다 */
  ...
  var MISSIONS = [
    ...
    { q:'q_plant',  lv:21, status:'모집 중' }, { q:'q_med',    lv:25, status:'모집 중' },
