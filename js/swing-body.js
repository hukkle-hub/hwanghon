...
(function(root){
  ...
  /* ⚠ 위 표는 «매끄러움만» 보고 고른 72번 값이다. 디렉터가 «맞는 순간 속도는
     ...
     목표는 js/ain-two-hand.js 의 BITE (근거 없음, 같이 조정할 값).
       ...
       attack3  0.60   0.73    0.70   0.87   ← 1.95 도 감속은 맞지만 접점 직전 몸 클립 스냅(원본 선형 키)이 2343°/s 로 튄다. 0.60 에서 1589 로 가장 낮다
     ...
     74번 — 3타·반격·스킬1·2 를 Meshy 클립으로 갈아 끼운 뒤 다시 쓸었다:
       attack3  0.60   0.38    0.70   0.22   ← k 0.2~1.4 전부 0.30~0.46. 찌르기가 박혀 선다
       counter  1.80   0.64    0.80   0.60   ← 새 클립은 접점 뒤 되베기가 빨라 k<1 이면 1.3~1.6 (맞고 나서 빨라짐)
       skill1   0.90   0.67    0.62   0.18
       skill2   0.60   ≈0.75   0.74   0.23 */
  var SEAM_BIAS = { attack1:1.05, attack3:0.60, smash:2.10, counter:1.80,
                    skill1:0.90, skill2:0.60, skill3:1.50, ult:1.95, exec:0.30 };
  /* ── 접점 감속 (bite) ──
