...
export class Animated{
 ...
 this.mixer.update(dt);this.rig?.apply(data.action?{...data.action,elapsed:Math.min(data.action.duration,data.action.elapsed+age)}:null,data.moving,data.guard,dt,this.current?.getClip().name);
 }
