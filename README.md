...
| `arena.html` | 훈련장 화면. SVG 허수아비, 예고 고리(흰색 구간 = 카운터 창), 피해 숫자, 안내 줄, 스테이지 오버레이 |

조작: 오른쪽 탭 = 공격, 길게 = 방어, 왼쪽 쓸기 = 회피, 허수아비 부위 탭 = 조준, 기술 1~4, 궁극기 R. 키보드: Space/J 공격, K 회피, L 방어, 1~4, R, Q 조준 전환.
