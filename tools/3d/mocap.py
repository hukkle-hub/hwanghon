...
CLIPS = [
    ...
    # 타격 — 가라테. peaks 로 잰 손목 최고속도를 괄호에 적는다.
    #   CMU 02(검술)는 «연습» 속도(2~4m/s)라 타격 본체로는 약하다. 가라테가 훨씬 무겁다.
    ('mo_strike',      '135', '09',  268,  366, True),   # 追い突き 순찌르기 (5.0 m/s)
    ('mo_strike_hard', '135', '01', 1085, 1215, True),   # 抜塞 발색 카타의 최고 타 (9.0 m/s)
    ('mo_sweep_low',   '135', '05',  509,  639, True),   # 下段払い 하단 쓸기 (6.8 m/s)
    ('mo_block_knife', '135', '10', 1681, 1811, True),   # 手刀受け 수도막기 (4.5 m/s)
    # 검 — 내려베기. 후반부가 앞쪽 연습 구간보다 빠르다.
    ('mo_sword_cut',   '02',  '07', 1813, 1943, True),   # (4.0 m/s)
