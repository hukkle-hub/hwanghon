...
최신 Render 검증: `38bf537ed67468dae5001fec487b7a579b5a9623`, 배포 `dep-danpfkoae00c739k3b80`, 2026-09-20 08:23:24 UTC live. 통합 테스트 182개 통과. `/healthz` 200/ok, 전투·리깅·재질·온라인 핵심 파일 7개가 배포 소스와 일치, 배포 직후 오류 로그 없음. `91e5db6` 전투 개선과 `f20f4df` 클로드 팔/재질/환경광 개선을 함께 포함한다. S25 Ultra 실기기 체감 검수는 별도다.
